...
#
# Generated by export_simulation on Thu Sep 24 09:40:53 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './ip_clk_pll_x2.sh' script.

./ip_clk_pll_x2.sh -reset_run
...
./ip_clk_pll_x2.sh -noclean_files

For more information on the script, please type './ip_clk_pll_x2.sh -help'.
