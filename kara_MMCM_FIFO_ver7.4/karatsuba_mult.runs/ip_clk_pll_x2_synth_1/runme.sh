...
HD_PWD='C:/1desktop/kara_MMCM_FIFO_ver7.4/karatsuba_mult.runs/ip_clk_pll_x2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_clk_pll_x2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_clk_pll_x2.tcl
