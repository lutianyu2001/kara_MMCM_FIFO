...
HD_PWD='C:/1desktop/kara_MMCM_FIFO_ver7.4/karatsuba_mult.runs/ip_fifo_256x64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_fifo_256x64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_fifo_256x64.tcl
