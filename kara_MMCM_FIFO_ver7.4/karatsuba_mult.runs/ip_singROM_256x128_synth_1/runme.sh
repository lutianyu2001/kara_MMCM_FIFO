...
HD_PWD='C:/1desktop/kara_MMCM_FIFO_ver7.4/karatsuba_mult.runs/ip_singROM_256x128_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_singROM_256x128.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_singROM_256x128.tcl
